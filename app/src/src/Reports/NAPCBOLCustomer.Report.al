report 50015 "ARC NAPC BOL Customer Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/NAPCBOLCustomer.Report.rdl';
    Caption = 'BOL Customer Report';
    ...
    dataset
    {
        ...
        dataitem("ARC NAPC BOL Header"; "ARC NAPC BOL Header")
        {
            ...
            begin
                ...
                HazMatOnly := "Shipping Agent Code" in ['UPS', 'DELIVERY', 'PICKUP'];
                NAPCBOLManagement.BuildBOLSummaryLines("No.", TempNAPCBOLSummaryLine);
                ...
                FormatAddress.NAPCBOLShipTo(ShipToAddress, "ARC NAPC BOL Header");
                FormatAddress.NAPCBOLShipFrom(ShipFromAddress, "ARC NAPC BOL Header");
