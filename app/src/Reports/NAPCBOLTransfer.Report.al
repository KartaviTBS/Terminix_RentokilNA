report 50016 "ARC NAPC BOL Transfer Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/NAPCBOLTransfer.Report.rdl';
    Caption = 'BOL Transfer Report';
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            column(Order_No_; "Transfer Order No.") { }
            column(Location_Code; "Transfer-to Code") { }
            ...
            dataitem("ARC NAPC BOL Header"; "ARC NAPC BOL Header")
            {
                ...
                trigger OnPreDataItem();
                begin
                    "Transfer Shipment Header".CalcFields("ARC NAPC Bill of Lading No.");
                    SetRange("No.", "Transfer Shipment Header"."ARC NAPC Bill of Lading No.");
                end;
    ...
    begin
        with "Transfer Shipment Header" do begin
            CalcFields("ARC NAPC Bill of Lading No.");
            if "ARC NAPC Bill of Lading No." = '' then begin
                NAPCBOLHeader.Init();
                NAPCBOLHeader."No." := '';
                NAPCBOLHeader.Insert(true);
                NAPCBOLHeader."Source Doc. Type" := NAPCBOLHeader."Source Doc. Type"::"Transfer Shipment";
                ...
                NAPCBOLHeader."Ship-to Source No." := "Transfer-to Code";
                NAPCBOLHeader."Ship-to Code" := "Transfer-to Code";
                NAPCBOLHeader."Ship-to Name" := "Transfer-to Name";
                NAPCBOLHeader."Ship-to Name 2" := "Transfer-to Name 2";
                NAPCBOLHeader."Ship-to Address" := "Transfer-to Address";
                NAPCBOLHeader."Ship-to Address 2" := "Transfer-to Address 2";
                NAPCBOLHeader."Ship-to City" := "Transfer-to City";
                NAPCBOLHeader."Ship-to County" := "Transfer-to County";
                NAPCBOLHeader."Ship-to Post Code" := "Transfer-to Post Code";
                NAPCBOLHeader."Ship-to Country/Region Code" := "Trsf.-to Country/Region Code";//;"Transfer-to Country/Region Code";
                NAPCBOLHeader."Ship-to Contact" := "Transfer-to Contact";
                //NAPCBOLHeader."Ship-to Phone No." := "Transfer-to Phone No."";
                NAPCBOLHeader."Ship-from Type" := NAPCBOLHeader."Ship-from Type"::Location;
                NAPCBOLHeader.Validate("Ship-from Source No.", "Transfer-from Code");
            ...
            FormatAddress.TransferShptTransferTo(ShipToAddress, "Transfer Shipment Header");
            FormatAddress.TransferShptTransferFrom(ShipFromAddress, "Transfer Shipment Header")
